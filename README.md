...
Modbus 页面默认隐藏，可通过主标签末尾的“+”添加。RTU和ASCII复用串口连接，TCP使用客户端连接；页面提供手动请求、顺序轮询、响应结果与原始帧记录。地址输入统一使用0基PDU地址，并同步显示常见的00001/10001/30001/40001参考号。轮询任务会自动保存，也可通过带版本号的JSON文件导入导出。
