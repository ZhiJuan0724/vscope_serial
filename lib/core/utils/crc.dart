...
final Map<String, CrcPoly> crc8Polys = {
  'CRC-8': const CrcPoly(
    name: 'CRC-8', width: 8, poly: 0x07, init: 0x00,
  ...
  'CRC-8/EBU': const CrcPoly(
    name: 'CRC-8/EBU', width: 8, poly: 0x1D, init: 0xFF,
    refIn: true, refOut: true, xorOut: 0x00,
  ),
  ...
  'CRC-8/ITU': const CrcPoly(
    name: 'CRC-8/ITU', width: 8, poly: 0x07, init: 0x00,
    refIn: false, refOut: false, xorOut: 0x55,
  ),
  'CRC-8/MAXIM': const CrcPoly(
    name: 'CRC-8/MAXIM', width: 8, poly: 0x31, init: 0x00,
    refIn: true, refOut: true, xorOut: 0x00,
  ),
...
final Map<String, CrcPoly> crc16Polys = {
  ...
  'CRC-16/AUG-CCITT': const CrcPoly(
    name: 'CRC-16/AUG-CCITT', width: 16, poly: 0x1021, init: 0x1D0F,
    refIn: false, refOut: false, xorOut: 0x0000,
  ),
  'CRC-16/BUYPASS': const CrcPoly(
    name: 'CRC-16/BUYPASS', width: 16, poly: 0x8005, init: 0x0000,
    refIn: false, refOut: false, xorOut: 0x0000,
  ),
  'CRC-16/CCITT': const CrcPoly(
    name: 'CRC-16/CCITT', width: 16, poly: 0x1021, init: 0x0000,
    refIn: true, refOut: true, xorOut: 0x0000,
  ),
  'CRC-16/CRC-IBM': const CrcPoly(
    name: 'CRC-16/CRC-IBM', width: 16, poly: 0x8005, init: 0x0000,
    refIn: true, refOut: true, xorOut: 0x0000,
  ),
  'CRC-16/IBM': const CrcPoly(
    name: 'CRC-16/IBM', width: 16, poly: 0x8005, init: 0x0000,
  ...
  'CRC-16/X-25': const CrcPoly(
    name: 'CRC-16/X-25', width: 16, poly: 0x1021, init: 0xFFFF,
    refIn: true, refOut: true, xorOut: 0xFFFF,
  ),
...
final Map<String, CrcPoly> crc32Polys = {
  'CRC-32': const CrcPoly(
    name: 'CRC-32', width: 32, poly: 0x04C11DB7, init: 0xFFFFFFFF,
  ...
  'CRC-32/POSIX': const CrcPoly(
    name: 'CRC-32/POSIX', width: 32, poly: 0x04C11DB7, init: 0x00000000,
    refIn: false, refOut: false, xorOut: 0xFFFFFFFF,
  ),
  'CRC-32/SATA': const CrcPoly(
    name: 'CRC-32/SATA', width: 32, poly: 0x04C11DB7, init: 0x52325032,
    refIn: false, refOut: false, xorOut: 0x00000000,
  ),
  'CRC-32C': const CrcPoly(
    name: 'CRC-32C', width: 32, poly: 0x1EDC6F41, init: 0xFFFFFFFF,
    refIn: true, refOut: true, xorOut: 0xFFFFFFFF,
  ),
  'CRC-32D': const CrcPoly(
    name: 'CRC-32D', width: 32, poly: 0xA833982B, init: 0xFFFFFFFF,
    refIn: true, refOut: true, xorOut: 0xFFFFFFFF,
  ),
  'CRC-32Q': const CrcPoly(
    name: 'CRC-32Q', width: 32, poly: 0x814141AB, init: 0x00000000,
    refIn: false, refOut: false, xorOut: 0x00000000,
  ),
};
...
Map<String, CrcPoly> getPolysByType(CrcType type) {
  switch (type) {
    case CrcType.crc8: return crc8Polys;
    case CrcType.crc16: return crc16Polys;
    case CrcType.crc32: return crc32Polys;
    default: return {};
  }
}
